...
-- Adds sprite metadata fields, monster seed data, character element stat storage,
-- and the RPC signatures used by the current frontend.
...
grant execute on function public.create_character(uuid, int, text, text, text, text, jsonb)
to anon, authenticated;

grant execute on function public.update_character_state(uuid, uuid, int, int, int, int, int, int, int, int, int, int, int)
to anon, authenticated;

grant execute on function public.use_element_point(uuid, uuid, text)
to anon, authenticated;
